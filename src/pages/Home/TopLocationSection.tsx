		...
		<section className="section-top-location">
			...
			<div className="location-city">
				<div
					...
					<img
						src="/resources/images/location_hcm.jpg"
						alt="khu-vuc-noi-bat"
					/>
				...
				<div
					className="location-item"
					onClick={() => filterSubmit("Hà Nội")}>
					<img
						src="/resources/images/location_hn.jpg"
						alt="khu-vuc-noi-bat"
					/>
					<div className="location-cap">
				...
				<div
					className="location-item"
					onClick={() => filterSubmit("Đà Nẵng")}>
					<img
						src="/resources/images/location_dn.jpg"
						alt="khu-vuc-noi-bat"
					/>
					<div className="location-cap">
